...
lv_obj_set_x( ui_batteryIcon, -10 );
...
ui_Button1 = lv_btn_create(ui_statusBar);
...
lv_obj_set_style_border_color(ui_Button1, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_FOCUSED );
lv_obj_set_style_border_opa(ui_Button1, 255, LV_PART_MAIN| LV_STATE_FOCUSED);
lv_obj_set_style_border_width(ui_Button1, 1, LV_PART_MAIN| LV_STATE_FOCUSED);

ui_Image12 = lv_img_create(ui_Button1);
